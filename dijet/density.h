...
class Collision {
    ...
    public:
        ...
        TH1*        QGSpectraRatioBDMPS(Int_t n_samples=10000, TH2* jets=0, Double_t qhatL=15.0, Double_t minPt=20.0, Double_t maxPt=640.0, Double_t n_quark=4.19, Double_t beta_quark=-0.71, Double_t n_gluon=4.69, Double_t beta_gluon=-0.80, Double_t quarkFrac=0.34);
