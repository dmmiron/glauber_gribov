...
THStack* SweepFlavor(TString lossFile, Int_t nsamples, Double_t b, Double_t normalization=10.0, Double_t phi=-1.0, Double_t minPt=100.0, Double_t maxPt=200.0, Bool_t combined=true);
...
THStack* FlavorsPlusCombined(TString lossFile, Int_t nsamples, Double_t b, Double_t normalization=10.0, Double_t phi=-1.0, vector<Double_t> fracs = {.25, .25, .25, .25},  Double_t minPt=100.0, Double_t maxPt=200.0); 

THStack* FlavorsPlusCombined(TString lossFile, Int_t nsamples, Double_t b, Double_t normalization=10.0, Double_t phi=-1.0, Double_t minPt=100.0, Double_t maxPt=200.0); 
